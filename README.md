...
- **Rating Sort**: "highest/top/best rated" sorts descending; "lowest/worst rated" sorts ascending — generic queries like "highest rated tv shows" return all items of that type sorted by rating
